package com.example.messengermaps.adapter
...
import com.example.messengermaps.activity.ChatActivity
...
class UserAdapter (private val context: Context, private val userList: ArrayList<User>):
    ...
    class ViewHolder(view: View):RecyclerView.ViewHolder(view){
        val  txtUserName:TextView= view.findViewById(R.id.usreName)
